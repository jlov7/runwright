...
- [ ] Execute full 35-item pre-release program from `docs/plans/2026-02-16-world-class-game-pre-release-program.md`
- [ ] RX1 Game client shell readiness
- [ ] RX2 Unified game-state contract
- [ ] RX3 Account/auth/profile progression
- [ ] RX4 Save/load + cloud sync conflict policy
- [ ] RX5 First-10-minute onboarding arc
- [ ] RX6 Adaptive tutorial overlays + hints
- [ ] RX7 Failure/recovery UX matrix
- [ ] RX8 Progression economy balancing framework
- [ ] RX9 Multi-phase boss encounter system
- [ ] RX10 Replay + ghost challenge sharing
- [ ] RX11 Challenge authoring templates
- [ ] RX12 Procedural generation quality constraints
- [ ] RX13 Adaptive difficulty guardrails
- [ ] RX14 Co-op session orchestration (join/leave/reconnect)
- [ ] RX15 Friends/party/invite flow
- [ ] RX16 Ranked authoritative scoring model
- [ ] RX17 Anti-cheat/anti-tamper safeguards
- [ ] RX18 Seasonal LiveOps control system
- [ ] RX19 UGC moderation and publish review flow
- [ ] RX20 UGC discovery/rating surfacing
- [ ] RX21 Telemetry event schema coverage
- [ ] RX22 Analytics dashboard feed contract
- [ ] RX23 Crash diagnostics and incident envelopes
- [ ] RX24 Performance budget enforcement surfaces
- [ ] RX25 Game-feel/cinematic timing controls
- [ ] RX26 Accessibility feature pack
- [ ] RX27 Localization readiness pack
- [ ] RX28 Offline/degraded network policy
- [ ] RX29 Abuse reporting workflow
- [ ] RX30 QA device/locale/latency matrix
- [ ] RX31 Staged rollout + rollback runbook
- [ ] RX32 On-call operations playbook
- [ ] RX33 App-store release pack checklist
- [ ] RX34 Legal/compliance readiness bundle
- [ ] RX35 Closed beta + balancing gate
- [ ] Final convergence gate for pre-release program
