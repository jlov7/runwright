...
- Evidence: Recent pushed heads fail before workflow steps execute because GitHub Actions cannot start jobs due to account billing limits. Sample `CI`/`CodeQL` run pairs: `22109118266`/`22109118280`, `22110929744`/`22110929736`, `22111146887`/`22111146880`, `22112492942`/`22112492922`, `22112524863`/`22112524890`, `22203952764`/`22203952755`, `22240155561`/`22240155541`, `22240196616`/`22240196630`, and latest `0d29cc9` runs `22243078342`/`22243078364` (all failing jobs recorded `steps: []` / `stepsCount: 0`); all annotate startup failure and billing/spending-limit guidance.
