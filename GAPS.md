...
- Status: In progress (Phase 1 complete: `apps/web/navigation.js`, `tests/frontend-navigation-disclosure.test.ts`; remaining guided-journey and layout/copy phases open)
