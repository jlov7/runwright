...
- [x] RG-007 platform incident exception documented with repeated recent-run evidence: `CI`/`CodeQL` runs `22109118266`/`22109118280`, `22110929744`/`22110929736`, `22111146887`/`22111146880`, and latest `22112492942`/`22112492922` all failed because GitHub Actions jobs were not started due to account billing/spending-limit restrictions; incident evidence recorded in `QUESTIONS.md` and `GAPS.md`.
