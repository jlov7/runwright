...
- [x] Latest ship gate run is green: `pnpm ship:gate` (`reports/quality/ship-gate.summary.json` generated `2026-02-15T21:36:15.372Z`, `overall.ok: true`).
...
- [x] Latest local gate reruns are green: `pnpm verify` (304/304 tests) and `pnpm run doctor` (`reports/doctor/doctor.json` generated `2026-02-15T21:33:47.775Z`, `overall.ok: true`).
