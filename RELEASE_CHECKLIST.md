...
- [x] Latest full local gates on `2026-02-21` are green: `pnpm verify` (390/390 tests passing, build green), `pnpm run doctor` (`reports/doctor/doctor.json` generated `2026-02-21T18:17:42.877Z`, `overall.ok: true`), `pnpm ship:gate` (`reports/quality/ship-gate.summary.json` generated `2026-02-21T18:20:30.059Z`, `overall.ok: true`), `pnpm quality:evidence:verify` (`ok: true`), and `pnpm release:verify-local` (`release artifact verification: ok`).
