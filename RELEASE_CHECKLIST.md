...
- [x] Frontend shell budget guard remains enforced with updated target (`<= 71 KB` HTML) and passing regression coverage (`scripts/check_frontend_performance.ts`, `tests/frontend-performance-script.test.ts`, `docs/design/frontend-performance-budgets.md`).
...
- [x] RG-007 platform incident exception documented with repeated recent-run evidence: sample `CI`/`CodeQL` pairs `22109118266`/`22109118280`, `22110929744`/`22110929736`, `22111146887`/`22111146880`, `22112492942`/`22112492922`, and `22112524863`/`22112524890` all failed because GitHub Actions jobs were not started due to account billing/spending-limit restrictions; incident evidence recorded in `QUESTIONS.md` and `GAPS.md`.
